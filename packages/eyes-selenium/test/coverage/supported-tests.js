const supportedTests = [
  ...
  {name: 'TestCheckFrameInFrame_Fully_Fluent', executionMode: {isScrollStitching: true}},
  ...
  {name: 'TestCheckFrameInFrame_Fully_Fluent2', executionMode: {isScrollStitching: true}},
  {
  ...
  {name: 'TestCheckPageWithHeaderFully_Region', executionMode: {isCssStitching: true}},
  {name: 'TestCheckPageWithHeaderFully_Region', executionMode: {isScrollStitching: true}},
  ...
  {name: 'TestCheckRegionByCoordinateInFrame_Fluent', executionMode: {isCssStitching: true}},
  {name: 'TestCheckRegionByCoordinateInFrame_Fluent', executionMode: {isScrollStitching: true}},
  {name: 'TestCheckRegionByCoordinateInFrameFully_Fluent', executionMode: {isVisualGrid: true}},
  {name: 'TestCheckRegionByCoordinateInFrameFully_Fluent', executionMode: {isCssStitching: true}},
  {
  ...
  {name: 'TestCheckRegionInFrame3_Fluent', executionMode: {isCssStitching: true}},
  ...
  {name: 'TestCheckRegionInAVeryBigFrame', executionMode: {isScrollStitching: true}},
  {
  ...
  {name: 'TestCheckWindowWithFloatingBySelector_Fluent', executionMode: {isVisualGrid: true}},
  ...
  {name: 'TestScrollbarsHiddenAndReturned_Fluent', executionMode: {isVisualGrid: true}},
  {name: 'TestScrollbarsHiddenAndReturned_Fluent', executionMode: {isCssStitching: true}},
